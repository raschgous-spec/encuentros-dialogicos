...
export const Encuentro1Momento = ({ onComplete }: Encuentro1MomentoProps) => {
  return (
      ...
      <Card className="border-primary/20 bg-primary/5">
        ...
        <CardContent>
          <p className="text-muted-foreground mb-4">
            Contenido del primer encuentro dialógico en construcción.
          </p>
          <ul className="space-y-2 text-sm text-muted-foreground list-disc list-inside">
            <li>Presentación de casos prácticos</li>
            <li>Actividades colaborativas</li>
            <li>Discusiones guiadas</li>
